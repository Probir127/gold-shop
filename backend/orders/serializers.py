...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # Auto-create core Invoice for Store & Admin
        try:
            import logging
            ...
            client, _ = Client.objects.get_or_create(
                ...
                defaults={'name': order.customer_name, 'status': 'invoiced'}
            )
            ...
            Invoice.objects.update_or_create(
                ...
                defaults={
                    ...
                    'total_amount': total,
                    'currency': 'BDT',
                    'status': 'paid' if order.payment_status == 'paid' else 'sent' if order.payment_method == 'cod' else 'draft',
